var Qixi = function () {
    var confi = {
        ...
        audio: {
            enable: true,
            playURl: "./audio/happy.mp3",
            cycleURL: "./audio/circulation.mp3"
        },
        setTime: {
            walkToThird: 6000,
            walkToMiddle: 6500,
        ...
        snowflakeURl: ["./images/flower_one.png",
                "./images/flower_two.png",
                "./images/flower_three.png",
                "./images/flower_four.png",
                "./images/flower_five.png",
                "./images/flower_six.png"]
    };
    var debug = 0;
    if (debug) {
